...
\frac{1}{1+\tau n}\right)
\end{equation*}
Second, to find the conditional distribution,
\(\tau\mid\mu,y\),
with known mean,
\(\mu\),
We assume a gamma-distributed prior,
...
\begin{align*}
  ...
  \left[
    -y\tran
    \ln\left(h_\theta(X)\right)
    -(1 - y)\tran
    \ln\left(1-h_\theta(X)\right)
  \right]
  + \frac{\lambda}{2m}
  \|\theta\|_2^2
    \\
  ...
  \left[
    ...
    \right)
    -(1 - y)\tran
    \ln\left(1-g\left(X\theta\right) \right)
  \right]
  + \frac{\lambda}{2m}
  \|\theta\|_2^2
    \\
